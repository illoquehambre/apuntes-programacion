...
public class Alumno {
	...
	public Alumno (int edad, String nombre, String apellidos, double notaMedia) {
		...
		this.edad=edad;//this.nombreAtributo = nombreVariable (en este caso se llaman igual, pero no tendr�a por que ser as�
	...
	//3. m�todo (getEdad)
	public int getEdad () {//no hay que darle nada en los par�ntesis para que de un valor, solo da no requiere datos introducido
	...
	//void indica que no devuelve ning�n dato de ningun tipo
	public void setEdad (int edad) {//se le debe dar un valor en los par�ntesis para oder introducir un valor
	...
	//primer m�todo
	public double añadirPuntos(double puntos) {//se est� declarando la variable puntos
