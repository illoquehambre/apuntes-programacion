...
public class Principal {
	...
	public static void main(String[] args) {
		...
		int desde=0, hasta=1000, tam1=0, tam2=0, tam3=0, ganador1=0, ganador2=0, ganador3=0;
		...
		System.out.println("Al final, se hará un sorteo de un abono anual gratuito entre todos los que compren entradas de cada partido, al final del programa.\n");
		...
		do {
			...
			System.out.println("Pulse [1] para vender entradas.");
			...
			switch(opcion1) {
				...
				case 2:
					System.out.printf("El dinero recaudado en el día de hoy es: %.2f€.\n",recaudo);
					break;
				case 3:
					if(entradasVendidas1==cero && entradasVendidas2==cero && entradasVendidas3==cero) {
						System.out.println("No se ha vendido ninguna entrada.\n");
					}else {
						if(entradasVendidas1==0) {
							System.out.println("En el partido 1 no se han vendido entradas.\n");
						}else {
							ganador1=randomEnt.nextInt(entradasVendidas1-desde+1)+desde;
							...
							System.out.println("Felicidades: "+name1[ganador1]+".");	
						}
						if(entradasVendidas2==0) {
							System.out.println("En el partido 2 no se han vendido entradas.\n");
						}else {
							ganador2=randomEnt.nextInt(entradasVendidas2-desde+1)+desde;
							...
							System.out.println("Felicidades: "+name2[ganador2]+".");
						}
						if(entradasVendidas3==0) {
							System.out.println("En el partido 3 no se han vendido entradas.\n");
						}else {
							ganador3=randomEnt.nextInt(entradasVendidas3-desde+1)+desde;
							...
							System.out.println("Felicidades: "+name3[ganador3]+".");
							}	
						}
					break;
				default:
