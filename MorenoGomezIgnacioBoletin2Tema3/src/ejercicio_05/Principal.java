	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				System.out.println("Introduzca el color que desee, en caso de que no est� disponible se le asignar� uno por defecto");
				color=Leer.dato();
			...
			case 6:
				...
				break;
			default:
				System.out.println("Opci�n no disponible, por favor intentelo de nuevo;");
			}
		}while(opcion!=0);
